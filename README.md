this is a small Tool that uses the Adafruit_Neopixel library (https://github.com/adafruit/Adafruit_NeoPixel) to control an LED strip connected to a raspberry pi
